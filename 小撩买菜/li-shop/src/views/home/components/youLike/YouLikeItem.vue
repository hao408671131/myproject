    ...
    <div class="wrapper">
        <div class="content">
            <div class="imageWrapper">
                ...
                <van-image class="image" :src="product.small_image" :alt="product.spec">
            ...
            <div class="infoWrapper">
                ...
                <div class="priceWrapper">
                    <div class="priceInfo">
                        <div class="pricePart">
                            <div class="price">
                               {{product.price|wholeMoneyFormat}}
                            </div>
                            <div class="originPrice">{{product.origin_price|wholeMoneyFormat}}</div>
                        </div>
                    </div>
